...
import py.com.base.interfaces.IConfiguracionEntidadEmiadqRepository;

@Component
public class ConfiguracionEntidadEmiadqDao implements IConfiguracionEntidadEmiadqRepository {
